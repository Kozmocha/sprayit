...
<h2><span class="blue">Water</span><span class="green">cooler</span></h2>
    <form action="<?php echo URL_ROOT . '/' . POSTS_EDIT . '/' ; ?><?php echo $_data['post_uuid']; ?>" method="post" style="padding-top: 25px;">
    <?php foreach($_data['posts'] as $post) : ?><div class="row" style="margin-bottom: -40px;">
